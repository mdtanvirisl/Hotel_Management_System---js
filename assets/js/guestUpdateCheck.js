function validGuestUpdate(){
    ...
    if(name != "" && email != "" && number != "" && gender != "" && flag == 5){
           
        update(name, email, number, gender, username);

    }
}

function update(name, email, number, gender, username){
    let xhttp = new XMLHttpRequest();
    xhttp.open("POST", "../controller/guestUpdateCheck.php", true);
